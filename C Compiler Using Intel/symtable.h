/*  Symbol Table --linked list  headers
    ...
    Symbol table header file that I did not have to change much besides add the create temp prototype
    and also add the prototypes for both search and insert 
    Joshua Rosencrans
   April 11, 2018
*/
